...
function AdjustMouth (position, mouthAU) 
{
    ...
    [rtx, rty] = [12.5*w, 1.8]; // right side top line control point
    [ltx, lty] = [-12.5*w, 1.8]; // left side top line control point

    [bx, by] = [0, -2];  // lip bottom x and y
    [rbx, rby] = [12.5*w, -1.4]; // right side bottom line control point
    [lbx, lby] = [-12.5*w, -1.4]; // left side bottom line control point
    chiny = -20
    nosey = 12
