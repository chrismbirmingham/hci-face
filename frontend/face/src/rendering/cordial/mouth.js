...
function AdjustMouth (position, mouthAU) 
{
    ...
    // SET BASELINES
    [center_x, center_y] = [position.x, position.y-3]; // location of the mouth - all coordinates relative to center
    const width_factor=.9;
...
function LinifyNose(nosePoints)
{
    ...
    var dis = [
        "M",center_x, center_y-nose_y-i,
        "L", center_x+i, center_y-nose_y+i, 
        "L", center_x-i, center_y-nose_y+i, 
        "L", center_x, center_y-nose_y-i, 
